...
<script>
    ...
    export default defineComponent({
        ...
        computed: {
            classes() {
                return this.active
                    ? 'inline-flex items-center px-1 pt-1 border-b-2 border-sjgreen no-underline text-sm font-medium leading-5 text-gray-900 hover:text-gray-400 hover:border-sjblue focus:outline-none focus:border-indigo-700 transition'
